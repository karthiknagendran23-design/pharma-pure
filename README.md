...
1. Click **"DEMO MODE"** in the top navigation header.
2. **Step 1 & 2 (2D Map):** Observe the Chennai/Tambaram parcel (`TN-CHN-TRP-00018427`) and click *VIEW IN 3D*.
3. **Step 3 & 4 (3D View):** Watch the 15-storey building render. Click **EXPLODE BUILDING FLOORS** to see floors separate vertically.
4. **Step 5 (Unit Selection):** Select **Unit 8B on Floor 8** to view its 1,240 sq.ft carpet area and masked owner record.
5. **Step 6 & 7 (ID & QR):** Click **RE-GENERATE SMART PROPERTY ID** to watch the visual animation, then open the **QR Digital Property Passport**.
6. **Step 8 & 9 (Revenue Verification):** Switch role to **Revenue Admin** to inspect the audit log and approve pending submissions.

---

## 📜 Disclaimer

*Identifiers generated by this prototype (e.g. ULPIN / VPID) are formatted as "ULPIN-Compatible Prototype Property IDs" for demonstration purposes and are designed for integration with future Government Digital Public Infrastructure specifications.*
